...
conf t
 ...
 router ospf 1
  router-id 52.0.0.1
  network 52.0.0.1 0.0.0.0 area 52
  network 10.52.52.0 0.0.0.255 area 52
...
conf t
 router ospf 1
  router-id 10.52.52.4
   network 10.52.0.0 0.0.255.255 area 52
 int gi 0/1
  ip ospf network point-to-point
  end
~~~
...
conf t
 router ospf 1
  ...
  network 10.52.100.0 0.0.0.255 area 52
  end
~~~
...
!@CoreTAAS
config t
 hostname CoreTAAS-52-(PLDT)
 Track 1 Int gi 0/1 line-protocol
 int vlan 1
  standby 1 ip 10.52.1.16
  standby 1 preempt
